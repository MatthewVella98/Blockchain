...
npm run cc:start -- kickstarter
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke kickstarter kickstarter_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- kickstarter org1
# Install to your blockchain - From the root of your project
hurl install kickstarter node -P ./chaincode-kickstarter
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install kickstarter node -P ./chaincode-kickstarter --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade kickstarter node 1.2 -P ./chaincode-kickstarter
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- kickstarter 1.2
```
