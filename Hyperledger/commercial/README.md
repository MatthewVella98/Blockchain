...
npm run cc:start -- aggreement
# Make a testing call to create a record in the ledger
# Beware that the first call may fail with a timeout! Just happens the first time
hurl invoke aggreement aggreement_create "{\"name\":\"my first request\",\"id\":\"0001\",\"created\":0,\"modified\":0}"
```
...
npm run cc:package -- aggreement org1
# Install to your blockchain - From the root of your project
hurl install aggreement node -P ./chaincode-aggreement
# Install in debug mode, this will run the chaincode server locally so you can debug
hurl install aggreement node -P ./chaincode-aggreement --debug

# Upgrade your existing chaincode - From the root of your project
hurl upgrade aggreement node 1.2 -P ./chaincode-aggreement
```
...
# Upgrade your existing chaincode - From the root of your project
npm run cc:upgrade -- aggreement 1.2
```
